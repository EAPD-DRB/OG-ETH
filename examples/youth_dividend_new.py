...
# OG-ETH calibrates its demographics to UN country 710 over the
...
_DEMOG_COUNTRY = "231"  # UN code for Ethiopia previous was 710 South Africa
...
def main():
    ...
    #
    # The packaged JSON is calibrated to country 710 (South Africa). Here we
